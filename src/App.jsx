          ...
          <div className="bottom">
            ...
            <div className="right">
              ...
              <p className="second-paragraph">
                Our goal is to deliver amazing experiences <br />
                that make people talk, and build strategic <br />
                value for brands, tech, entertainment, <br />
                arts & culture.
              </p>
              <div className="social-links">
                <a href="#">Facebook</a> / <a href="#">Instagram</a> / <a href="#">Dribbble</a> / <a href="#">Twitter</a> / <a href="#">Newsletter</a>
              </div>
            </div>
          </div>
